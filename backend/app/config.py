...
class Settings(BaseSettings):
    ...
    # API速率限制配置
    # IPHub API配额（每天1000次，使用990次留余量）
    IPHUB_DAILY_LIMIT: int = 1000
    IPHUB_DAILY_USAGE: int = 990

    # IPQualityScore API配额（每月5000次，每天150次）
    IPQUALITYSCORE_MONTHLY_LIMIT: int = 5000
    IPQUALITYSCORE_DAILY_USAGE: int = 150

    # Proxycheck.io API配额（免费，每天1000次）
    PROXYCHECK_DAILY_LIMIT: int = 1000
    PROXYCHECK_DAILY_USAGE: int = 999
